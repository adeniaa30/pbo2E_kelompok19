...
class MyFrame2 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 500,379 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_staticText2 = wx.StaticText( self, wx.ID_ANY, u"Tambah Penerbit", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText2.SetForegroundColour( wx.Colour( 16, 153, 205 ) )
		...
		self.m_staticText3 = wx.StaticText( self, wx.ID_ANY, u"Masukkan Nama Penerbit :", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText321 = wx.StaticText( self, wx.ID_ANY, u"Masukkan Kota Penerbit :", wx.DefaultPosition, wx.DefaultSize, 0 )
