...
class MyFrame2 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText2 = wx.StaticText( self, wx.ID_ANY, u"Hapus Penerbit", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText2.SetForegroundColour( wx.Colour( 56, 132, 224 ) )
