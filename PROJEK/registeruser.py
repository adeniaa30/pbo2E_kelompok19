...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 293,270 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.btndaftar = wx.Button( self.m_panel3, wx.ID_ANY, u"DAFTAR", wx.DefaultPosition, wx.DefaultSize, 0 )
		gSizer2.Add( self.btndaftar, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.btncancelregister = wx.Button( self.m_panel3, wx.ID_ANY, u"CANCEL", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.btnbacklogin = wx.Button( self, wx.ID_ANY, u"BACK TO LOGIN", wx.DefaultPosition, wx.DefaultSize, 0 )
